...
while True:
    ...
    if event in (None, 'Execute'):
        ...
        def script():
            def get_image():
                driver.get(
                    "file:///Users\\rhysthomas\\Documents\\Tests\\ocr\\tests\\index.html")
